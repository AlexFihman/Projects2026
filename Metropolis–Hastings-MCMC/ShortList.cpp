...
ShortList::ShortList(const ShortList& other, std::mt19937& rng) : size(other.size), rng(rng) {
    std::copy(other.arr, other.arr + MAX_SIZE, arr);
    std::copy(other.containsArr, other.containsArr + MAX_SIZE, containsArr);
    std::copy(other.indexArr, other.indexArr + MAX_SIZE, indexArr);
}
